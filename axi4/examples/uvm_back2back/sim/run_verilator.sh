...
if [[ "${REUSE_BUILD}" != "1" || ! -x "${BIN}" ]]; then
  ${VERILATOR_BIN} -sv --language 1800-2017 -Wno-fatal -Wno-PKGNODECL -Wno-UNDRIVEN -Wno-TIMESCALEMOD -Wno-SYNCASYNCNET -Wno-MISINDENT -Wno-WIDTHTRUNC -Wno-WIDTHEXPAND --timing --binary -j "${JOBS}" \
